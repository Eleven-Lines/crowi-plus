module.exports = function(crowi, app) {
  ...
  app.get('/login'                   , middleware.applicationInstalled()    , loginPassport.loginWithMikan, login.login);
  ...
  if (Config.isEnabledPassport(config)) {
    ...
    app.post('/_api/login/testMikan'  , loginRequired(crowi, app) , form.login , loginPassport.testMikanCredentials);
  }
  else {
  ...
  app.post('/_api/admin/settings/conoha', loginRequired(crowi, app) , middleware.adminRequired() , csrf, form.admin.conoha, admin.api.appSetting);
  ...
  app.post('/_api/admin/security/passport-mikan' , loginRequired(crowi, app) , middleware.adminRequired() , csrf, form.admin.securityPassportMikan, admin.api.securityPassportMikanSetting);
  ...
  app.post('/admin/user/:id/authorize'  , loginRequired(crowi, app) , middleware.adminRequired() , csrf, admin.user.authorize);
  app.post('/admin/user/:id/unauthorize', loginRequired(crowi, app) , middleware.adminRequired() , admin.user.unauthorize);
  ...
  if (Config.isEnabledPassport(config)) {
    ...
    app.post('/me/external-accounts/associateMikan'         , loginRequired(crowi, app) , form.login , me.externalAccounts.associateMikan);
  }
  ...
  app.get( '/files/user/:id([0-9a-z]{24}).:ext(*)' , loginRequired(crowi, app, false) , user.api.iconRedirector);
